    ...
    return (
      <main className="min-h-screen bg-[var(--surface-0)] px-3 py-6 text-white sm:px-4 lg:px-6">
        <div className="mx-auto max-w-3xl rounded-[32px] border border-white/[0.06] bg-white/[0.04] p-6 shadow-[0_24px_100px_rgba(0,0,0,0.28)] backdrop-blur-2xl sm:p-8">
          ...
          <Link
            href="/support"
            className="mt-6 inline-flex rounded-2xl border border-white/[0.06] bg-white/[0.03] px-4 py-2 text-sm font-medium text-white/72 transition hover:bg-white/[0.06]"
          >
            Contact support
          </Link>
        </div>
      ...
      <main className="min-h-screen bg-[var(--surface-0)] px-3 py-6 text-white sm:px-4 lg:px-6">
        <div className="mx-auto max-w-3xl rounded-[32px] border border-white/[0.06] bg-white/[0.04] p-6 shadow-[0_24px_100px_rgba(0,0,0,0.28)] backdrop-blur-2xl sm:p-8">
          ...
          <Link
            ...
            className="mt-6 inline-flex rounded-2xl bg-[var(--text-primary)] px-4 py-2 text-sm font-medium text-[var(--surface-0)] shadow-[0_0_20px_rgba(245,245,240,0.04)] transition-all duration-300 hover:shadow-[0_0_30px_rgba(245,245,240,0.08)]"
          >
  ...
  return (
    <main className="min-h-screen bg-[var(--surface-0)] px-3 py-6 text-white sm:px-4 lg:px-6">
      <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="rounded-[32px] border border-white/[0.06] bg-white/[0.04] p-6 shadow-[0_24px_100px_rgba(0,0,0,0.28)] backdrop-blur-2xl sm:p-8">
          ...
          <div className="mt-8 space-y-3">
            <div className="rounded-[24px] border border-white/[0.06] bg-white/[0.03] p-4 text-sm text-white/68">
