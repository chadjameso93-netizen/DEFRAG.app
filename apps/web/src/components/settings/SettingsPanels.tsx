    ...
    <div className="grid gap-4 lg:grid-cols-2 lg:gap-6">
      <GlowCard className="p-6">
        ...
        <div className="mt-6 grid gap-3">
          <div className="glass-surface-light p-4 text-sm text-white/70">Email notifications</div>
          <div className="glass-surface-light p-4 text-sm text-white/70">Password reset</div>
        </div>
      </GlowCard>
      ...
      <GlowCard className="p-6">
        ...
        <div className="mt-6 glass-surface-light p-4">
        ...
        <button
          ...
          className="mt-4 w-full rounded-2xl border border-white/10 bg-white/5 px-5 py-3 text-sm font-medium text-white transition hover:bg-white/[0.06] disabled:opacity-50"
        >
      ...
      <GlowCard className="p-6">
        ...
        <div className="mt-6 grid gap-3">
          <div className="glass-surface-light p-4 text-sm text-white/70">Data is encrypted at rest</div>
          <div className="glass-surface-light p-4 text-sm text-white/70">No third-party data sharing</div>
          <div className="glass-surface-light p-4 text-sm text-white/70">Export or delete your data anytime</div>
        </div>
      </GlowCard>
